...
namespace FormAutoHub.Api.Data.Migrations
{
    ...
    [Migration("20260604211823_NckhPhase5_DataCollectionNormalization")]
    partial class NckhPhase5_DataCollectionNormalization
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FormAutoHub.Api.Entities.Nckh.ModelRelation", b =>
                {
                    ...
                    b.Property<Guid>("FromVariableId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("HypothesisCode")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("HypothesisText")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("FromVariableId");

                    b.HasIndex("ToVariableId");

                    b.HasIndex("ModelId", "HypothesisCode")
                        .IsUnique();

                    b.HasIndex("ModelId", "FromVariableId", "ToVariableId")
                        .IsUnique();

                    b.ToTable("ModelRelations", t =>
                        {
                            t.HasCheckConstraint("CK_ModelRelations_NoSelfRelation", "[FromVariableId] <> [ToVariableId]");
                        });
                });

            modelBuilder.Entity("FormAutoHub.Api.Entities.Nckh.NodePosition", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("ModelId", "NodeType", "RelationId")
                        .IsUnique()
                        .HasFilter("[RelationId] IS NOT NULL");

                    b.HasIndex("ModelId", "NodeType", "VariableId")
                        .IsUnique()
                        .HasFilter("[VariableId] IS NOT NULL");

                    b.ToTable("NodePositions", t =>
                        {
                            t.HasCheckConstraint("CK_NodePositions_ExactlyOneTarget", "(([VariableId] IS NOT NULL AND [RelationId] IS NULL) OR ([VariableId] IS NULL AND [RelationId] IS NOT NULL))");
                        });
                });
            ...
            modelBuilder.Entity("FormAutoHub.Api.Entities.Nckh.ModelRelation", b =>
                {
                    ...
                    b.HasOne("FormAutoHub.Api.Entities.Nckh.ResearchVariable", "ToVariable")
                        .WithMany("IncomingRelations")
                        .HasForeignKey("ToVariableId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("FromVariable");

                    b.Navigation("Model");

                    b.Navigation("ToVariable");
                });
            ...
            modelBuilder.Entity("FormAutoHub.Api.Entities.Nckh.NodePosition", b =>
                {
                    ...
                    b.HasOne("FormAutoHub.Api.Entities.Nckh.ModelRelation", "Relation")
                        .WithMany("NodePositions")
